...
// Cursova2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCursova2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCursova2App

CCursova2App::CCursova2App()
{
...
// Единственный объект CCursova2App

CCursova2App theApp;
SystemProgram Program;

// Инициализация CCursova2App

BOOL CCursova2App::InitInstance()
{
